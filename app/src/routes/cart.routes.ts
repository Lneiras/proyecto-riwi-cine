 ...
 *         products:
 *           type: array
 *           description: Referencias de confitería; disponibles cuando se integre su catálogo.
 *           items:
 *             type: object
 *             properties:
 ...
 *     description: Bloquea las sillas agregadas y libera las eliminadas. La confitería responderá 501 hasta integrar su catálogo.
 *     tags: [Cart]
 *     security: [{ bearerAuth: [] }]
 *     requestBody:
 *       required: true
 ...
 *       401: { description: Usuario no autenticado }
 *       404: { description: Carrito o función inexistente }
 *       409: { description: Una silla no se puede bloquear }
 *       501: { description: Catálogo de confitería todavía no disponible }
 *   delete:
